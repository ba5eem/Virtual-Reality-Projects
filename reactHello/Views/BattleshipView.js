 ...
 * it from all angles.
 */
class BattleshipView extends React.Component {
  ...
  render() {
    ...
    else if(this.props.posts[this.props.current].id !== 'assets/aYAmfkUYZjg'){
      console.log('nope')
      return null;
    }
...
const ConnectedBattleshipView = connect(BattleshipView);

export default ConnectedBattleshipView;