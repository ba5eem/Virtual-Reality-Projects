...
class DroneView extends React.Component {
  ...
  render() {
    ...
    else if(this.props.posts[this.props.current].id !== 'assets/dDt0xsKy7qv'){
      return null;
    }
    ...
    return (
      <View>
        ...
        />
        <AnimatedEntity
          style={{transform: [{ rotateY: this.rotation, rotateZ: 180 }]}}
...
const ConnectedDroneView = connect(DroneView);

export default ConnectedDroneView;