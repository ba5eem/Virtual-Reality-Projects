 ...
 * it from all angles.
 */
class IslandView extends React.Component {
  ...
  render() {
    ...
    else if(this.props.posts[this.props.current].id !== 'assets/2SkKFl4GjIr'){
      return null;
    }
...
const ConnectedIslandView = connect(IslandView);

export default ConnectedIslandView;